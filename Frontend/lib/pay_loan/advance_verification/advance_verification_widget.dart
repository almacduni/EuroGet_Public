...
import 'advance_verification_model.dart';
export 'advance_verification_model.dart';

class AdvanceVerificationWidget extends StatefulWidget {
  const AdvanceVerificationWidget({Key? key}) : super(key: key);

  @override
  _AdvanceVerificationWidgetState createState() =>
      _AdvanceVerificationWidgetState();
}

class _AdvanceVerificationWidgetState extends State<AdvanceVerificationWidget> {
  late AdvanceVerificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdvanceVerificationModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<IssuedLoansRow>>(
      future: IssuedLoansTable().querySingleRow(
        queryFn: (q) => q.eq(
          'instalment_id',
      ...
      builder: (context, snapshot) {
        ...
        List<IssuedLoansRow> advanceVerificationIssuedLoansRowList =
            snapshot.data!;
        final advanceVerificationIssuedLoansRow =
            advanceVerificationIssuedLoansRowList.isNotEmpty
                ? advanceVerificationIssuedLoansRowList.first
                : null;
                                                      ...
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Wrap(
                                                            ...
                                                            children: [
                                                              Text(
                                                                advanceVerificationIssuedLoansRow!
                                                                    .loanId,
                                                                textAlign:
                                                                    TextAlign
                                                                        .end,

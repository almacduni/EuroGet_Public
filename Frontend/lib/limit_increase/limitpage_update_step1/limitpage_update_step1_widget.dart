...
import 'limitpage_update_step1_model.dart';
export 'limitpage_update_step1_model.dart';

class LimitpageUpdateStep1Widget extends StatefulWidget {
  const LimitpageUpdateStep1Widget({Key? key}) : super(key: key);

  @override
  _LimitpageUpdateStep1WidgetState createState() =>
      _LimitpageUpdateStep1WidgetState();
}

class _LimitpageUpdateStep1WidgetState
    extends State<LimitpageUpdateStep1Widget> {
  late LimitpageUpdateStep1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LimitpageUpdateStep1Model());
  }
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'iszx73pm' /* How much do you want to receiv... */,
                                    ),

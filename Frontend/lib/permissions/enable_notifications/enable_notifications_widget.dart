...
class EnableNotificationsWidget extends StatefulWidget {
  const EnableNotificationsWidget({Key? key}) : super(key: key);

  @override
  _EnableNotificationsWidgetState createState() =>
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '9kkpm4r3' /* Maintain your financial  safet... */,
                                    ),
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            context.pushNamed('membershipBanner');
                          },
                          child: Container(

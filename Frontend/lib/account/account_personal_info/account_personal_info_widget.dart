...
import 'account_personal_info_model.dart';
export 'account_personal_info_model.dart';

class AccountPersonalInfoWidget extends StatefulWidget {
  const AccountPersonalInfoWidget({Key? key}) : super(key: key);

  @override
  _AccountPersonalInfoWidgetState createState() =>
      _AccountPersonalInfoWidgetState();
}

class _AccountPersonalInfoWidgetState extends State<AccountPersonalInfoWidget> {
  late AccountPersonalInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountPersonalInfoModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: FutureBuilder<List<AccountInfoRow>>(
            future: AccountInfoTable().querySingleRow(
              queryFn: (q) => q.eq(
                'user_id',
                currentUserUid,
              ),
            ...
            builder: (context, snapshot) {
              ...
              List<AccountInfoRow> columnAccountInfoRowList = snapshot.data!;
              final columnAccountInfoRow = columnAccountInfoRowList.isNotEmpty
                  ? columnAccountInfoRowList.first
                  : null;
              return Column(

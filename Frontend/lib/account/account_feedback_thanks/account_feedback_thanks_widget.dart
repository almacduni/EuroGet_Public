...
import 'account_feedback_thanks_model.dart';
export 'account_feedback_thanks_model.dart';

class AccountFeedbackThanksWidget extends StatefulWidget {
  const AccountFeedbackThanksWidget({Key? key}) : super(key: key);

  @override
  _AccountFeedbackThanksWidgetState createState() =>
      _AccountFeedbackThanksWidgetState();
}

class _AccountFeedbackThanksWidgetState
    extends State<AccountFeedbackThanksWidget> {
  late AccountFeedbackThanksModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountFeedbackThanksModel());
  }
                          ...
                          children: [
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'sbank4vv' /* Thank you  for your feedback! */,
                                  ),
                            ...
                            Wrap(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'iemzdeoj' /* It really helps. Check back so... */,
                                  ),
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium

...
import 'account_support_thanks_model.dart';
export 'account_support_thanks_model.dart';

class AccountSupportThanksWidget extends StatefulWidget {
  const AccountSupportThanksWidget({Key? key}) : super(key: key);

  @override
  _AccountSupportThanksWidgetState createState() =>
      _AccountSupportThanksWidgetState();
}

class _AccountSupportThanksWidgetState
    extends State<AccountSupportThanksWidget> {
  late AccountSupportThanksModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountSupportThanksModel());
  }
                          ...
                          children: [
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'pqpxmaxm' /* Your ticket has been submitted... */,
                                  ),
                            ...
                            Wrap(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'ais3xnu9' /* We will get back to you within... */,
                                  ),
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium

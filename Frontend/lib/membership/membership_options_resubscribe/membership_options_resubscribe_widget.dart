...
import 'membership_options_resubscribe_model.dart';
export 'membership_options_resubscribe_model.dart';

class MembershipOptionsResubscribeWidget extends StatefulWidget {
  const MembershipOptionsResubscribeWidget({Key? key}) : super(key: key);

  @override
  _MembershipOptionsResubscribeWidgetState createState() =>
      _MembershipOptionsResubscribeWidgetState();
}

class _MembershipOptionsResubscribeWidgetState
    extends State<MembershipOptionsResubscribeWidget> {
  late MembershipOptionsResubscribeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MembershipOptionsResubscribeModel());
  }
                                  ...
                                  children: [
                                    ...
                                    Wrap(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '6o3k3dgl' /* Choose the option that works b... */,
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'qj1yd5ym' /* Auto-renewable. Cancel anytime... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
